...
class MmppsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mmpp" do
    assert_difference('Mmpp.count') do
      post mmpps_url, params: { mmpp: { densidad: @mmpp.densidad, descripcion: @mmpp.descripcion, nombre: @mmpp.nombre } }
    end
  ...
  test "should update mmpp" do
    patch mmpp_url(@mmpp), params: { mmpp: { densidad: @mmpp.densidad, descripcion: @mmpp.descripcion, nombre: @mmpp.nombre } }

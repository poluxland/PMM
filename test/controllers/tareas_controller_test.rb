...
class TareasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tarea" do
    assert_difference('Tarea.count') do
      post tareas_url, params: { tarea: { criticidad: @tarea.criticidad, descripcion: @tarea.descripcion, otros: @tarea.otros } }
    end
  ...
  test "should update tarea" do
    patch tarea_url(@tarea), params: { tarea: { criticidad: @tarea.criticidad, descripcion: @tarea.descripcion, otros: @tarea.otros } }

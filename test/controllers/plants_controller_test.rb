...
class PlantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plant" do
    assert_difference('Plant.count') do
      post plants_url, params: { plant: { descripcion: @plant.descripcion, otros: @plant.otros, personal: @plant.personal } }
    end
  ...
  test "should update plant" do
    patch plant_url(@plant), params: { plant: { descripcion: @plant.descripcion, otros: @plant.otros, personal: @plant.personal } }

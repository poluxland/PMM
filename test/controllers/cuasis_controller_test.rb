...
class CuasisControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cuasi" do
    assert_difference('Cuasi.count') do
      post cuasis_url, params: { cuasi: { accion: @cuasi.accion, estado: @cuasi.estado, fecha: @cuasi.fecha, potencial: @cuasi.potencial, reporta: @cuasi.reporta, responsable: @cuasi.responsable, sitio: @cuasi.sitio } }
    end
  ...
  test "should update cuasi" do
    patch cuasi_url(@cuasi), params: { cuasi: { accion: @cuasi.accion, estado: @cuasi.estado, fecha: @cuasi.fecha, potencial: @cuasi.potencial, reporta: @cuasi.reporta, responsable: @cuasi.responsable, sitio: @cuasi.sitio } }

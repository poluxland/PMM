...
class SectorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sector" do
    assert_difference('Sector.count') do
      post sectors_url, params: { sector: { area: @sector.area, instalacion: @sector.instalacion } }
    end
  ...
  test "should update sector" do
    patch sector_url(@sector), params: { sector: { area: @sector.area, instalacion: @sector.instalacion } }

...
class EvaluacionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evaluacion" do
    assert_difference('Evaluacion.count') do
      post evaluacions_url, params: { evaluacion: { barrido: @evaluacion.barrido, comentarios: @evaluacion.comentarios, derrames: @evaluacion.derrames, orden: @evaluacion.orden, promedio: @evaluacion.promedio, sector_id: @evaluacion.sector_id } }
    end
  ...
  test "should update evaluacion" do
    patch evaluacion_url(@evaluacion), params: { evaluacion: { barrido: @evaluacion.barrido, comentarios: @evaluacion.comentarios, derrames: @evaluacion.derrames, orden: @evaluacion.orden, promedio: @evaluacion.promedio, sector_id: @evaluacion.sector_id } }

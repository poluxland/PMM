...
class BrusControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bru" do
    assert_difference('Bru.count') do
      post brus_url, params: { bru: { comentarios: @bru.comentarios, fecha: @bru.fecha, ingreso: @bru.ingreso, mmpp: @bru.mmpp, numero: @bru.numero, patente: @bru.patente, salida: @bru.salida } }
    end
  ...
  test "should update bru" do
    patch bru_url(@bru), params: { bru: { comentarios: @bru.comentarios, fecha: @bru.fecha, ingreso: @bru.ingreso, mmpp: @bru.mmpp, numero: @bru.numero, patente: @bru.patente, salida: @bru.salida } }

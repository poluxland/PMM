...
class AreasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create area" do
    assert_difference('Area.count') do
      post areas_url, params: { area: { criticidad: @area.criticidad, descripcion: @area.descripcion, otros: @area.otros } }
    end
  ...
  test "should update area" do
    patch area_url(@area), params: { area: { criticidad: @area.criticidad, descripcion: @area.descripcion, otros: @area.otros } }
